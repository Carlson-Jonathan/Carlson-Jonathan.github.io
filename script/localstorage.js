...
/*****************************************************************************
* stringify(num)
* This function executes the stringify function of JSON.
*****************************************************************************/
function stringify(object1,num) {
    var object2 = new flatten(object1);
    var objectString = JSON.stringify(object2);
    
    // Under which button should it be displayed?
    switch(num) {
        case 1:
            document.getElementById("strone").innerHTML = objectString;
            break;
        case 2:
            document.getElementById("strtwo").innerHTML = objectString;
            break;
        case 3:
            document.getElementById("strthree").innerHTML = objectString;
            break;
    }
}
...
/*****************************************************************************
* flatten(obj)
* This converts our object with the inheritence to a format that is cpmpatible
* with JSON.stringify(). Otherwise, we would only see our child object's
* properties displayed in the string output.
*****************************************************************************/
...
/*****************************************************************************
* jsonParse(obj)
* This converts the stringified object, back into an object using JSON.parse
*****************************************************************************/
function jsonParse() {
    var str = document.getElementById("jsonString").value
    var studentObject = JSON.parse(str);
    document.getElementById("objname").innerHTML = studentObject.name;
    document.getElementById("objgpa").innerHTML = studentObject.gpa;
    document.getElementById("objmajor").innerHTML = studentObject.major;
    document.getElementById("objloc").innerHTML = studentObject.loc;
    document.getElementById("objgen").innerHTML = studentObject.gen;
    document.getElementById("objage").innerHTML = studentObject.age;
}

/*****************************************************************************
* function - storeThis(char)
* This saves the string information in the input box to both the local and
* session storage areas (depending on the parameter input).
*****************************************************************************/
function storeThis(ses) {
    if (ses == 'l') {
        localStorage.setItem("lStorage", document.getElementById("store").value);
    } else if(ses == 's') {
        sessionStorage.setItem("sStorage", document.getElementById("store").value);
    }
}

/*****************************************************************************
* Calls the information from the local and session storage on refresh.
*****************************************************************************/
document.getElementById("lString").innerHTML = 
    localStorage.getItem("lStorage");
document.getElementById("sString").innerHTML = 
    sessionStorage.getItem("sStorage");
